    ...
    >
      <TiltCard tiltAmount={6}>
        <GlowBorder borderRadius="1rem">
          <div className="premium-card shine-on-hover rounded-md p-7 h-full group">
            <motion.div
              className="w-12 h-12 rounded-sm bg-gold/[0.07] border border-gold/10 flex items-center justify-center text-gold mb-6 group-hover:bg-gold/[0.12] group-hover:border-gold/20 group-hover:shadow-[0_0_24px_rgba(59,130,246,0.1)] transition-all duration-500"
            ...
            <p className="text-[15px] text-muted-foreground leading-normal mb-5">
              {feature.description}
            </p>
...
export function AgentSection() {
  return (
    <section id="agents" className="relative py-24 overflow-hidden bg-background" style={{ zIndex: 50 }}>
      ...
      <div className="mx-auto px-6 lg:px-16">
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-lg text-muted-foreground mt-5 max-w-md mx-auto leading-normal">
        ...
        <div className="mt-12 text-center">
          <a
            href="/SKILL.md"
            target="_blank"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-gold/30 hover:shadow-md transition-all"
          >
