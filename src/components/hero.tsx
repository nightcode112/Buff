        ...
        <div className="grid lg:grid-cols-[1fr_460px] gap-20 items-center">
          <div className="max-w-2xl">
            ...
            <div className="animate-fade-up mt-8 flex flex-wrap items-center gap-2.5" style={{ animationDelay: "0.8s" }}>
              {[
                { href: "https://github.com/nightcode112/Buff", icon: (
                ...
                ), label: "Stars", value: "GitHub" },
                { href: "https://www.npmjs.com/package/buff-protocol-sdk", icon: (
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M0 7.334v8h6.666v1.332H12v-1.332h12v-8H0zm6.666 6.664H5.334v-4H3.999v4H1.335V8.667h5.331v5.331zm4 0h-2.666V8.667h2.666v5.331zm12.001 0h-1.333v-4h-1.334v4h-1.333v-4h-1.334v4h-2.666V8.667h8v5.331z"/></svg>
                ), label: "Downloads", value: "npm" },
                { href: "https://www.npmjs.com/package/buff-protocol-sdk", icon: (
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M20.24 12.24a6 6 0 00-8.49-8.49L5 10.5V19h8.5z"/><path d="M16 8L2 22M17.5 15H9"/></svg>
                ), label: "v1.0.1", value: "SDK" },
              ].map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  ...
                  className="flex items-center gap-1.5 text-xs text-muted-foreground/70 hover:text-muted-foreground transition-colors px-2.5 py-1 rounded-full border border-border/30 bg-card/40 backdrop-blur-sm"
                >
